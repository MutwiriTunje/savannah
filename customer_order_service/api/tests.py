...
#         phone_number = customer.phone_number  # Assuming you've validated the number


#         # Now call your send_sms_instance to send the SMS
#         send_sms_instance = send_sms()
#         send_sms_instance.send(phone_number=phone_number)
...
#         message = f"Thank you for your ordering "
#         sender = "myShopKe"
